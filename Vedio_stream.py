...
def create_linear_topology():
    ...
    with open('iperf_results_60_0.5_vedio', 'a') as results_file:
        duration = 60
        interval = 0.5
        ...
        for i in range(num_runs):
            ...
            # Starting a video streaming from host 1 to host 2
            net.get('h1').cmd('cvlc /path/to/video.mp4 --sout "#rtp{{dst={},port=1234}}" &'.format(h2_ip))
