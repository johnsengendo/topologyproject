...
def create_linear_topology():
    ...
    delays = [150]#, 50, 100, 200]  # Delays in milliseconds
    ...
    for delay in delays:
        ...
        with open('iperf_results_60_0.5_delay150', 'a') as results_file:
            duration = 60
            interval = 0.5
            ...
            for i in range(num_runs):
                ...
                thread = threading.Thread(target=run_iperf, args=(net.get('h1'), h2_ip, duration, interval, results_file))
...
def run_iperf(h1, h2_ip, duration, interval, results_file):
